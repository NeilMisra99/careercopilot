/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 193d78c29c5203053277c45b1cf50088)
// Runtime types generated with workerd@1.20250525.0 2025-03-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TOKEN_KV: KVNamespace;
		EMAIL_SYNC_RATE_KV: KVNamespace;
		AI_RATE_LIMIT_KV: KVNamespace;
		SCRAPING_CACHE_KV: KVNamespace;
		SUPABASE_URL: string;
